...
```
    ...
    ## # A tibble: 49 × 7
    ##    group litter_number   gd0_weight gd18_weight pups_born_alive pups_dead_birth
    ##    <chr> <chr>                <dbl>       <dbl>           <dbl>           <dbl>
    ##  1 Con7  #85                   19.7        34.7               3               4
    ##  2 Con7  #1/2/95/2             27          42                 8               0
    ##  3 Con7  #5/5/3/83/3-3         26          41.4               6               0
    ##  4 Con7  #5/4/2/95/2           28.5        44.1               5               1
    ##  5 Con7  #4/2/95/3-3           NA          NA                 6               0
    ##  6 Con7  #2/2/95/3-2           NA          NA                 6               0
    ##  7 Con7  #1/5/3/83/3-3/2       NA          NA                 9               0
    ##  8 Con8  #3/83/3-3             NA          NA                 9               1
    ##  9 Con8  #2/95/3               NA          NA                 8               0
    ## 10 Con8  #3/5/2/2/95           28.5        NA                 8               0
...
```
    ...
    ## # A tibble: 49 × 8
    ##    grp   lit_num         gd0_weight gd18_weight gd_of_birth pups_born_alive
    ##    <chr> <chr>                <dbl>       <dbl>       <dbl>           <dbl>
